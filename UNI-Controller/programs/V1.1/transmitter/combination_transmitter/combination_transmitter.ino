...
//
  ...
  throttle = map(analogRead(A2), 0, 1024, -256, 256);
  yaw      = map(analogRead(A3), 0, 1024, -256, 256);
  pitch    = map(analogRead(A0), 0, 1024, -256, 256);
  roll     = map(analogRead(A1), 0, 1024, -256, 256);
